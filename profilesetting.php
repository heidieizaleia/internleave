...
<body data-theme="light">
    ...
    <div class="main-wrapper">
        ...
        <div class="profile-card">
            ...
            <div class="info-row"><label>Semester</label><span><?php echo $sem; ?></span></div>
            ...
            <div class="settings-section">
                ...
                <form id="personalInfoForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="<?php echo $student_id; ?>" readonly style="cursor:not-allowed; opacity:0.7;">
                    </div>
