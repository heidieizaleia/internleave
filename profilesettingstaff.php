<?php
// ==========================================
// BACKEND LOGIC: FETCH & UPDATE STAFF DATA
// ==========================================
session_start();
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    echo "<script>alert('✅ Profile Updated Successfully!'); window.location.href='profilesettingstaff.php';</script>";
    exit();
}
...
$full_name = $user['staff_name'] ?? 'Staff Member';
$email = $user['email'] ?? '';
$phone = $user['phone_no'] ?? '';
...
<head>
    <meta charset="UTF-8">
    <title>Staff Settings | InternLeave</title>
...
<body data-theme="light">
    ...
    <div class="marquee-container">
        <div class="marquee-text"><span>✨ Customize your profile and application preferences here.</span></div>
    </div>
    ...
    <nav>
        ...
        <div class="nav-links">
            ...
            <a href="profilesettingstaff.php" class="active">Settings</a>
    ...
    <div class="main-wrapper">
        ...
        <div class="profile-card">
            ...
            <div class="info-row"><label>Staff ID</label><span><?php echo $staff_id; ?></span></div>
            <div class="info-row"><label>Role</label><span>Supervisor</span></div>
